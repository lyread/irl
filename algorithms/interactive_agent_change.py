...
class InteractiveAgent(Agent):
    ...
    def _action_prob(self, old_distance, new_distance):
        """
        Make some change
        ...
        Returns:
            float: A probability between 0 and 1.  for "undo" behavior
        """
        if new_distance >= 2 * old_distance:
            ...
            # Linearly map the range [old_distance, 2*old_distance] to [1, 0]
            return 1 - (new_distance - old_distance) / old_distance
